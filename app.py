...
try:    # Optional for style, importing pyfiglet module
    ...
    print(f.renderText('Aunt Bee’s Cheesecake'))
...
def get_name(shop_name = 'Aunt Bee’s Cheesecakes'):
...
def order2(shop_name = 'Aunt Bee’s Cheesecakes'):  # For ordering different types of items.
    print('')
